# double_tap_player_view_plus

[![pub package](https://img.shields.io/pub/v/double_tap_player_view_plus.svg)](https://pub.dev/packages/double_tap_player_view_plus)
...
# Sample
![sample_screenshot](https://github.com/HiroyukTamura/double_tap_player_view_plus/blob/master/image/sample_screenshot.gif)
...
# Installation
Add double_tap_player_view_plus: ^1.0.3 to your pubspec.yaml dependencies. And import it:
...
this example shows the [sample screenshot](https://github.com/HiroyukTamura/double_tap_player_view_plus#sample).
